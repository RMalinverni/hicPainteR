...
hic_loops_file<-"/mnt/data1/HiCUP/Macro_Insulation/HIC/ENCODE_hepg2/loops/ENCODE_hic_hepg2.chr10.hiccups_loops/merged_loops.bedpe"
...
Hic_DF<-DFfromHIC(hicFile = "/mnt/data1/HiCUP/Macro_Insulation/HIC/ENCODE_hepg2/hic/ENCODE_hic_hepg2.chr10.hic",
                  zoom = zoom,
