...
#' @param pCol charachter - color used if \code use_ramp == FALSE ( default "red" )
...
#' @param use_ramp logic - select to switch from flat color to \code colorRampPalette ( default FALSE )
